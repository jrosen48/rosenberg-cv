---
title: "Joshua Rosenberg's Vita"
first: "dude"
date: "Updated `r Sys.Date()`"
output:
  pagedown::html_paged:
    self_contained: false
    css: [rosenberg-cv.css]
...
# to render to PDF
# pagedown::chrome_print("rosenberg-cv.Rmd")
...
if(PDF) {
  header <- '
  View online
  <a href="https://datalorax.github.io/rosenberg-cv/" class="icon-block">
  ...
  header <- '
  Download PDF
  <a href="https://github.com/datalorax/rosenberg-cv/raw/master/rosenberg-cv.pdf" class="icon-block">
...
<div class = "footer",>
  ...
  <a href="mailto:jmrosenberg@utk.edu class="icon-block">
      <i class="fas fafooter fa-envelope"> | </i>
  </a>
  
  <a href="https://www.joshuamrosenberg.com" class="icon-block">
      <i class="fas fafooter fa-globe"> | </i>
  </a>
  
  <a href="(http://orcid.org/0000-0003-2170-0447" class="icon-block">
...
<div class = "first", id="bloc1">Joshua M.</div>  
<div class = "last", id="bloc2">Rosenberg</div>
...
make_cite <- function(authors,	year,	title,	journal = NULL,	volume = NULL,	
  ...
  authors <- gsub(
    "Rosenberg, D\\.?",
    "<span style= 'font-weight: 500'>Rosenberg, D.</span>", 
    authors)
